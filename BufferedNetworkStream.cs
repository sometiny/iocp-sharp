    ...
    public class BufferedNetworkStream : IocpNetworkStream
    {
        ...
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int size, AsyncCallback callback, object state)
        {
            ...
            if (_length == 0 && _buffered)
            {
                ...
                BufferedReadResult asyncResult = new BufferedReadResult(callback, state, buffer, offset, size);
        ...
        private void AfterRead(IAsyncResult asyncResult)
        {
            ...
            BufferedReadResult asyncReadResult = asyncResult.AsyncState as BufferedReadResult;
            try
            {
